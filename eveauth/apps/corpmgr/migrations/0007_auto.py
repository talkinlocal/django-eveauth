...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        'corpmgr.allianceprofile': {
            ...
            'groups': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'alliances_allowed'", 'symmetrical': 'False', 'to': "orm['auth.Group']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
        ...
        'corpmgr.corporationprofile': {
            ...
            'groups': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'corps_allowed'", 'symmetrical': 'False', 'to': "orm['auth.Group']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
