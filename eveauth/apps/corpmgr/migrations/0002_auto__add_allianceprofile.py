...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('corpmgr_allianceprofile', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('alliance', self.gf('django.db.models.fields.related.OneToOneField')(related_name='mgmt_profile', unique=True, to=orm['eve_auth.Alliance'])),
            ('alliance_name', self.gf('django.db.models.fields.CharField')(max_length=128)),
            ...
            ('api_mask', self.gf('django.db.models.fields.IntegerField')(null=True)),
            ('created_on', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('last_modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal('corpmgr', ['AllianceProfile'])


    def backwards(self, orm):
        # Deleting model 'AllianceProfile'
        db.delete_table('corpmgr_allianceprofile')
