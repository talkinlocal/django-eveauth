...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'AllianceProfile.alliance_name'
        db.delete_column('corpmgr_allianceprofile', 'alliance_name')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'AllianceProfile.alliance_name'
        raise RuntimeError("Cannot reverse this migration. 'AllianceProfile.alliance_name' and its values cannot be restored.")
