...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Section.corporate_owner'
        db.add_column('forum_section', 'corporate_owner',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='corp_forum_sections', null=True, to=orm['corpmgr.CorporationProfile']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Section.corporate_owner'
        db.delete_column('forum_section', 'corporate_owner_id')
