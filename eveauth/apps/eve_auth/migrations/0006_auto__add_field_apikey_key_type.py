...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'APIKey.key_type'
        db.add_column('eve_auth_apikey', 'key_type',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=12),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'APIKey.key_type'
        db.delete_column('eve_auth_apikey', 'key_type')
    ...
    models = {
        ...
        'eve_auth.apikey': {
            ...
            'key_type': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '12'}),
