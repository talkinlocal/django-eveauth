...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'CorporationProfile', fields ['alliance_profile']
        db.delete_unique('corpmgr_corporationprofile', ['alliance_profile_id'])


        # Changing field 'CorporationProfile.alliance_profile'
        db.alter_column('corpmgr_corporationprofile', 'alliance_profile_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['corpmgr.AllianceProfile']))
        # Adding unique constraint on 'CorporationProfile', fields ['corporation', 'alliance_profile']
        db.create_unique('corpmgr_corporationprofile', ['corporation_id', 'alliance_profile_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'CorporationProfile', fields ['corporation', 'alliance_profile']
        db.delete_unique('corpmgr_corporationprofile', ['corporation_id', 'alliance_profile_id'])


        # Changing field 'CorporationProfile.alliance_profile'
        db.alter_column('corpmgr_corporationprofile', 'alliance_profile_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, null=True, to=orm['corpmgr.AllianceProfile']))
        # Adding unique constraint on 'CorporationProfile', fields ['alliance_profile']
        db.create_unique('corpmgr_corporationprofile', ['alliance_profile_id'])
