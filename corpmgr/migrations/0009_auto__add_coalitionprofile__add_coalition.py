...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CoalitionProfile'
        db.create_table('corpmgr_coalitionprofile', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('coalition', self.gf('django.db.models.fields.related.OneToOneField')(related_name='mgmt_profile', unique=True, to=orm['corpmgr.Coalition'])),
            ('manager', self.gf('django.db.models.fields.related.ForeignKey')(related_name='coalitions_managed', to=orm['auth.User'])),
            ('director_group', self.gf('django.db.models.fields.related.OneToOneField')(related_name='coalition_managers_of', unique=True, to=orm['auth.Group'])),
            ('created_on', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('last_modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal('corpmgr', ['CoalitionProfile'])

        # Adding model 'Coalition'
        db.create_table('corpmgr_coalition', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=80)),
            ('created_on', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('last_modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal('corpmgr', ['Coalition'])


    def backwards(self, orm):
        # Deleting model 'CoalitionProfile'
        db.delete_table('corpmgr_coalitionprofile')

        # Deleting model 'Coalition'
        db.delete_table('corpmgr_coalition')
