...
urlpatterns = patterns('corpmgr.views',
        ...
        url(r'^apply/success/$', TemplateView.as_view(template_name='corpmgr/app_success.html'),
            name='corpmgr_success'),
        ...
        url(r'^director/(?P<corpid>\d+)/(?P<status>-?\d+)/$', login_required(DirectorCorpView.as_view()),
            name='director_corp_dashboard_status'),
        ...
        url(r'^director/character/(?P<charid>\d+)/$', login_required(DirectorCharacterReport.as_view()),
            name='director_character_report'),
        url(r'^director/standings/report/$', login_required(DirectorStandingsReport.as_view()),
            name='director_standings_report'),
        bootstrap_delete('^applications/(?P<pk>\d+)/delete/$', 'corp_application_delete',
                         view=CorpApplicationDeleteView.as_view(), model=CorporationApplication),
)
